<?php	include('../logging.php');
	...
	getAuthentName($cnx, $user, $greetings, $firstName, $lastName);
		...
		$sql = "SELECT JSON_EXTRACT(e.infos, \"$.pages[3]\") AS numPage FROM events AS e WHERE e.id = " . $event;
			if ($fetch = $cnx->query($sql)) {
				...
				$relatedEvent = $result['numPage'];
					...
					logging($cnx, "ERROR", "error query - reason:" . $cnx->error, "events", "connaissances.php");
			}
		...
		><head
			><meta charset="utf-8"><meta name="author" content="Business Forward Technology (business.forward.technology@gmail.com)"><meta name="description" content="Web application pour une interactivité à fort impact sociétal. Notre objectif est de répondre à vos besoins en interactivité digitale et contribuer à votre politique RSE en matière d'inclusion des personnes en situation de handicap."><meta name="generator" content="talenha - a programming language"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="preload" as="font" type="font/ttf" crossorigin="" href="../fonts/Open-Sans/OpenSans-Regular.ttf"/><link rel="icon" type="image/png" href="../favicon.png"/><title
				>Connaissances - Conférence HANDIGO</title
				...
				><div
					...
					><div
						...
						><span
							...
							><strong
								>Input :</strong
							>80 % des situations de handicap sont invisibles.</span
						><br/><span
							style="height:10pt"
							></span
						><br/><u
							>Jeu de rôles :</u
						>un étudiant joue le rôle d’une personne ayant un déficit attentionnel auditif. Il dit qu’il lui est impossible de gérer plusieurs conversations dans une réunion.  <br/><u
							>Question :</u
						>comment manager le handicap invisible?  <br/><span
							style="height:10pt"
							></span
						><br/><span
							style="background-color:blue;color:white"
							>Chaque étudiant est invité à commenter ce qui se passe pendant la scène jouée</span
						><br/><span
							style="height:10pt"
							></span
						><br/><u
							>Objectif pédagogique :</u
						>définir le management inclusif.  <br/><u
							>Conclusion :</u
						>le manager qui anticipe ces situations, optimise ses modes de management et garantit le bien être de tous ses collaborateurs.</div
					><div
