<?php	include('../logging.php');
	...
	getAuthentName($cnx, $user, $greetings, $firstName, $lastName);
		...
		$sql = "SELECT JSON_EXTRACT(e.infos, \"$.pages[2]\") AS numPage FROM events AS e WHERE e.id = " . $event;
			if ($fetch = $cnx->query($sql)) {
				...
				$relatedEvent = $result['numPage'];
					...
					logging($cnx, "ERROR", "error query - reason:" . $cnx->error, "events", "experiences.php");
			}
		...
		><head
			><meta charset="utf-8"><meta name="author" content="Business Forward Technology (business.forward.technology@gmail.com)"><meta name="description" content="Web application pour une interactivité à fort impact sociétal. Notre objectif est de répondre à vos besoins en interactivité digitale et contribuer à votre politique RSE en matière d'inclusion des personnes en situation de handicap."><meta name="generator" content="talenha - a programming language"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="preload" as="font" type="font/ttf" crossorigin="" href="../fonts/Open-Sans/OpenSans-Regular.ttf"/><link rel="icon" type="image/png" href="../favicon.png"/><title
				>Expériences - Conférence HANDIGO</title
				...
				><div
					...
					><div
						...
						><span
							...
							><strong
								>Input :</strong
							>20 % des situations de handicap sont visibles.</span
						><br/><span
							style="height:10pt"
							></span
						><br/><u
							>Jeu de rôles :</u
						>deux étudiants et un intervenant jouent le DRH, le manager, et la personne en situation de handicap.  <br/><u
							>Question :</u
						>Comment manager le handicap visible?  <br/><span
							style="height:10pt"
							></span
						><br/><span
							style="background-color:blue;color:white"
							>Votez pour une situation de handicap et commentez la scène jouée.</span
						><br/><span
							style="height:10pt"
							></span
						><br/><u
							>Objectif pédagogique :</u
						>prendre conscience de son potentiel de communication et d’adaptation.  <br/><u
							>Conclusion :</u
						>Le manager qui est en capacité de communiquer et d’être une courroie de transmission entre le DRH et la personne en situation de handicap gagne en légitimité.</div
					><div
