<?php	include('logging.php');
	...
	getAuthentName($cnx, $user, $greetings, $firstName, $lastName);
		...
		><head
			...
			><link rel="stylesheet" href="css/m-horizontal-styles.css"/><link rel="stylesheet" href="css/m-vertical-styles.css" media="all and (orientation: landscape)"/><link href="css/model1.css" rel="stylesheet"/><style
				>
					.connectionName {
