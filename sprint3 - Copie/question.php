<?php	include('logging.php');
	...
	getAuthentName($cnx, $user, $greetings, $firstName, $lastName);
		...
		><link href="css/model1.css" rel="stylesheet"/><link rel="stylesheet" href="css/message-horizontal-c0-320px.css" media="all and (min-width:320px) and (orientation:landscape)"/><link rel="stylesheet" href="css/message-horizontal-c0-700px.css" media="all and (min-width:700px) and (orientation:landscape)"/><link rel="stylesheet" href="css/message-horizontal-c0-1000px.css" media="all and (min-width:1000px) and (orientation:landscape)"/><link rel="stylesheet" href="css/message-vertical-c0-320px.css" media="all and (min-width:320px) and (orientation:portrait)"/><link rel="stylesheet" href="css/message-vertical-c0-700px.css" media="all and (min-width:700px) and (orientation:portrait)"/><link rel="stylesheet" href="css/message-vertical-c0-1000px.css" media="all and (min-width:1000px) and (orientation:portrait)"/><style
			>
				.connectionName {
		...
		><div
			...
			><div
				...
				><div
					class="hbox-k"
					><div
						class="hbox-element-l"
						><div
							class="vbox-m"
							><div
								class="vbox-element-n"
								>&nbsp;</div
							><div
								class="vbox-element-o hideSB"
								><div
									class="vbox-a"
									><div
										...
										><div
											class="flex-row"
											style="width:200px;height:100%;height:58px;margin:0 auto;margin-bottom:20px"
											><div
												style="height:50%"
												><div
													style="display:inline-flex;height:24px;width:100%;width:200px;margin:0 auto;margin-bottom:10px"
													><div
														style="width:1%"
														>&nbsp;</div
													><div
										...
										><div
											...
											><div
												...
												><div
													...
													>&nbsp;</div
												><div
													class="hbox-element-g"
													><div
														id="questions"
														><?php $sql = "SELECT e.id AS id, q.content AS content, e.likes AS likes, e.moderation AS moderation, e.selected AS selected, e.source AS source, NOW() AS date FROM questions AS q, evqust AS e WHERE e.id_event = " . $event . " AND e.id_question = q.id AND e.suppressed = 0 AND e.moderation = 1 ORDER BY e.source DESC, e.likes DESC";
																if ($fetch = $cnx->query($sql)) {
