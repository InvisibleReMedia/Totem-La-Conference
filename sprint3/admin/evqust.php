								...
								><div
									...
									><div
										...
										><?php
											...
											?><a
											href="evqust.php?&option=<?php echo $option?>&num_page=<?php echo $num_page?>&lines_per_page=<?php echo $lines_per_page?>"
											>Actualiser</a
										><form
											method="POST"
											action="evqust.php?&option=<?php echo $option?>&num_page=<?php echo $num_page?>&lines_per_page=<?php echo $lines_per_page?>"
											><div
												id="newRecord"
												class="group hidden"
												><div
												...
												><div
													><div
														...
														></div
													><div
														><input type="text" name="id_question"/></div
													></div
												><div
													><div
														><label
												...
												><div
													><div
														...
														></div
													><div
														><input type="text" name="likes"/></div
													></div
												><div
													><div
														><label
														...
														></div
													><div
														><input type="text" name="selected"/></div
													></div
												><div
													><div
														><label
														...
														></div
													><div
														><input type="text" name="moderation"/></div
													></div
												><div
													><div
														><label
														...
														></div
													><div
														><input type="text" name="suppressed"/></div
													></div
												><div
													><div
										...
										><?php
											if (!empty($_POST)) {
												...
												if (array_key_exists('id_question', $_POST)) {
											...
											if ($postEnabled) {
												if ($insert) {
													$sql = "INSERT INTO evqust(id_event, id_question, id_user, date, source, likes, selected, moderation, suppressed) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
												} else {
													$sql = "UPDATE evqust SET id_event = ?, id_question = ?, id_user = ?, date = ?, source = ?, likes = ?, selected = ?, moderation = ?, suppressed = ? WHERE id = ?";
												}
												if ($stmt = $cnx->prepare($sql)) {
													if ($insert) {
														$stmt->bind_param("iiisiiiii", $id_event, $id_question, $id_user, $date, $source, $likes, $selected, $moderation, $suppressed);
													} else {
														$stmt->bind_param("iiisiiiiii", $id_event, $id_question, $id_user, $date, $source, $likes, $selected, $moderation, $suppressed, $id);
													}
													if (!$stmt->execute()) {
														echo $stmt->error;
													}
												...
												if ($query = $cnx->query($sql)) {
													...
													$sql = "SELECT id, id_event, id_question, id_user, date, source, likes, selected, moderation, suppressed FROM evqust" . " LIMIT " . strval($lines_per_page) . " OFFSET " . strval($skip_lines);
											...
											><tbody
												><!--make a dynamic loop of values--><?php
													...
													><td
														><?php echo htmlspecialchars($row['id_question']) ?></td
													><td
														><?php echo htmlspecialchars($row['id_user']) ?></td
													><td
														><?php echo htmlspecialchars($row['date']) ?></td
													><td
														><?php echo htmlspecialchars($row['source']) ?></td
													><td
														><?php echo htmlspecialchars($row['likes']) ?></td
													><td
														><?php echo htmlspecialchars($row['selected']) ?></td
													><td
														><?php echo htmlspecialchars($row['moderation']) ?></td
													><td
														><?php echo htmlspecialchars($row['suppressed']) ?></td
													></tr
												><tr
															...
															><div
																...
																><div
																	><div
																		...
																		></div
																	><div
																		><input type="text" name="id_question" value="<?php echo htmlspecialchars($row['id_question']) ?>"/></div
																	></div
																><div
																	><div
																		><label
																...
																><div
																	><div
																		...
																		></div
																	><div
																		><input type="text" name="source" value="<?php echo htmlspecialchars($row['source']) ?>"/></div
																	></div
																><div
																	><div
																		><label
																		...
																		></div
																	><div
																		><input type="text" name="likes" value="<?php echo htmlspecialchars($row['likes']) ?>"/></div
																	></div
																><div
																	><div
																		><label
																		...
																		></div
																	><div
																		><input type="text" name="selected" value="<?php echo htmlspecialchars($row['selected']) ?>"/></div
																	></div
																><div
																	><div
																		><label
																		...
																		></div
																	><div
																		><input type="text" name="moderation" value="<?php echo htmlspecialchars($row['moderation']) ?>"/></div
																	></div
																><div
																	><div
																		><label
																		...
																		></div
																	><div
																		><input type="text" name="suppressed" value="<?php echo htmlspecialchars($row['suppressed']) ?>"/></div
																	></div
																><div
																	><div
