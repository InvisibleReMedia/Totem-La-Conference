								...
								><div
									...
									><div
										...
										><?php
											...
											?><a
											href="events.php?&option=<?php echo $option?>&num_page=<?php echo $num_page?>&lines_per_page=<?php echo $lines_per_page?>"
											>Actualiser</a
										><form
											method="POST"
											action="events.php?&option=<?php echo $option?>&num_page=<?php echo $num_page?>&lines_per_page=<?php echo $lines_per_page?>"
											><div
												id="newRecord"
												class="group hidden"
												><div
										...
										><?php
											...
											><tbody
												><!--make a dynamic loop of values--><?php
													...
													><td
														><?php echo htmlspecialchars($row['title']) ?></td
													><td
															...
															><div
																...
																><input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']) ?>"/><div
																	><div
																		...
																		></div
																	><div
																		><input type="text" name="title" value="<?php echo htmlspecialchars($row['title']) ?>"/></div
																	></div
																><div
																	><div
																		><label
																	...
																	><div
																		><div
																			...
																			><table
																				...
																				></table
																			></div
																		><input type="text" style="width:140px" name="date_start" value="<?php echo htmlspecialchars($row['date_start']) ?>" data-ref="<?php echo $row['id']?>"/><img src="date.png" style="position:relative;left:10px;top:5px;max-height:15px;cursor:pointer" onclick="loadCalendar('date_start',<?php echo $row['id']?>);openCalendar(<?php echo $row['id']?>)"/></div
																	></div
																><div
																	><div
																		><label
																	...
																	><div
																		><div
																			...
																			><table
																				...
																				></table
																			></div
																		><input type="text" style="width:140px" name="date_end" value="<?php echo htmlspecialchars($row['date_end']) ?>" data-ref="<?php echo $row['id']?>"/><img src="date.png" style="position:relative;left:10px;top:5px;max-height:15px;cursor:pointer" onclick="loadCalendar('date_end',<?php echo $row['id']?>);openCalendar(<?php echo $row['id']?>)"/></div
																	></div
																><div
																	><div
																		><label
																		...
																		></div
																	><div
																		><input type="text" name="address" value="<?php echo htmlspecialchars($row['address']) ?>"/></div
																	></div
																><div
																	><div
																		><label
